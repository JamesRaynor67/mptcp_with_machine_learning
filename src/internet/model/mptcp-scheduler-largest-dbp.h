 ...
 */
#ifndef MPTCP_SCHEDULER_LARGEST_DBP_H
#define MPTCP_SCHEDULER_LARGEST_DBP_H
...
class MpTcpSchedulerLargestDBP : public MpTcpScheduler
{

public:
  static TypeId GetTypeId (void);

  MpTcpSchedulerLargestDBP();
  virtual ~MpTcpSchedulerLargestDBP ();
...
#endif /* MPTCP_SCHEDULER_LARGEST_DBP_H */
