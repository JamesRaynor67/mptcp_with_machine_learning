...
protected:
   ...
   * \param p The packet associated with the option
   */
  virtual void AddOptions (TcpHeader& tcpHeader, Ptr<const Packet> p);
  ...
  /**
   * \brief Add the MPTCP options to the header
   *
   * \param tcpHeader TcpHeader to add options to
   * \param p The packet associated with the option
   */
  virtual void AddMpTcpOptions (TcpHeader& header, Ptr<const Packet> p);
