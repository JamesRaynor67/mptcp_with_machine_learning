...
void
TcpSocketBase::AddOptions (TcpHeader& header, Ptr<const Packet> p)
{
...
void
TcpSocketBase::AddMpTcpOptions (TcpHeader& header, Ptr<const Packet> p)
{
  NS_LOG_FUNCTION(this);
