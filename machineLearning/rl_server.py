...
if __name__ == "__main__":
    ...
    while batch_count < 1000:
        ...
        copyfile("/home/hong/workspace/mptcp/ns3/mptcp_output/calculate_reward", '/home/hong/workspace/mptcp/ns3/rl_training_data/' + str(batch_count) + '_calculate_reward')
