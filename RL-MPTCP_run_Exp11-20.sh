...
summaryDir="/home/hong/result_figure/summary_${timestamp}"
mkdir ${summaryDir}
cp "/home/hong/result_figure/rcv.png" "${summaryDir}/rcv_${timestamp}_${tcpBuffer}_${routerBBuffer}_${routerCBuffer}_${link_b_BER}.png"
cp "/home/hong/result_figure/sent.png" "${summaryDir}/sent_${timestamp}_${tcpBuffer}_${routerBBuffer}_${routerCBuffer}_${link_b_BER}.png"
cp "/home/hong/result_figure/statistic.csv" "${summaryDir}/statistic_${timestamp}_${tcpBuffer}_${routerBBuffer}_${routerCBuffer}_${link_b_BER}.csv"
